...
// static sMsgQRef gMqttMsgQueue = NULL;
// static sTaskRef gMqttrocessTask = NULL;
// static uint8_t gMqttTaskStack[MQTT_TASK_STACK_SIZE];

// static void sTask_MqttProc(void *ptr);
